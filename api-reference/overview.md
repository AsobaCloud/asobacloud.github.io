...
|-----|-----------|----------|
| Inverter Telemetry | `client.inverter_telemetry` / `sdk.inverterTelemetry` | `https://api.asoba.org` |
| OODA Terminal Alerts | `client.ooda_terminal` / `sdk.oodaTerminal` | `https://api.asoba.org` |
| Partner API | `client.partner_api` / `sdk.partnerApi` | `https://api.asoba.org` |
