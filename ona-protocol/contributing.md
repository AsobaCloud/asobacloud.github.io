...
- **Discord** — [Join our community](https://discord.gg/v4vD5EXSUD) for real-time discussion with maintainers and other contributors
- **GitHub Issues** — For bugs, feature requests, and technical questions
- **Email** — [support@asoba.org](mailto:support@asoba.org) for sensitive or security-related matters
