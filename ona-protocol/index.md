...
<div class="product-cards">
  ...
  <!-- Contributing Guide Card -->
  <div class="product-card zorora">
    <h3>Contributing</h3>
    <p>How to contribute to ODS-E: environment setup, adding OEM transforms, PR protocol, and community guidelines.</p>
    <div class="card-tags">
      <span class="tag">Open Source</span>
      <span class="tag">Transforms</span>
      <span class="tag">PRs</span>
    </div>
    <a href="/ona-protocol/contributing" class="card-cta">Read More</a>
  </div>
